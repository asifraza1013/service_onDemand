        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['order-list','cancel-order-list','order-success-setting'])): ?>
                    <li
                        class="<?php echo e(active_menu('admin-home/orders')); ?>

                        <?php if(request()->is(['admin-home/orders','admin-home/orders/cancel-orders','admin-home/orders/order-success-settings','admin-home/orders/order-details*'])): ?> active <?php endif; ?>">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-list-ol"></i>
...
<?php /**PATH /Users/asifraza/Documents/proejcts/laravel/ext/adeel/service_onDemand/resources/views/backend/partials/sidebar.blade.php ENDPATH**/ ?>