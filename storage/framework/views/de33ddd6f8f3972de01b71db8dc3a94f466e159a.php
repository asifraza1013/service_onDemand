                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="dashboard-settings margin-top-40">
                                ...
                                <small class="text-danger"><?php echo e(__('Coupon will applicable only for your services and coupon amount will be reduce from your earnings.')); ?></small>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifraza/Documents/proejcts/laravel/ext/adeel/service_onDemand/resources/views/frontend/user/seller/coupons/coupons.blade.php ENDPATH**/ ?>