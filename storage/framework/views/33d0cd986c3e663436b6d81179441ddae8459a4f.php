                                ...
                                <div class="single-flex-middle">
                                    <div class="single-flex-middle-inner">
                                        <div class="line-charts-wrapper margin-top-40">
                                            ...
                                            <div class="single-checbox">
                                                <div class="checkbox-inlines">
                                                    <label><strong><?php echo e(__('Date:')); ?> </strong><?php echo e(Carbon\Carbon::parse($order_details->date)->format('d/m/y')); ?></label>
                                                </div>
                                                <div class="checkbox-inlines">
...
<?php echo $__env->make('frontend.user.buyer.buyer-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\qixer_bytesed_laravel\@core\resources\views/frontend/user/buyer/order/order-details.blade.php ENDPATH**/ ?>