                                    ...
                                    <div class="col-lg-8 margin-top-30">
                                        <div class="service-overview-wrapper padding-bottom-30">
                                            ...
                                            <?php if($service_details_for_book->is_service_online == 1): ?>
                                                <?php if($service_faqs): ?>
                                                <div class="overview-single padding-top-60">
                                                    <h4 class="title"><?php echo e(get_static_option('service_faqs_title') ?? __('Faqs:')); ?></h4>
                                                    <ul class="overview-benefits margin-top-30">
                                                        <?php $__currentLoopData = $service_faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <li class="list"><?php echo e($faq->title); ?></li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </ul>
                                                </div>
                                              <?php endif; ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifraza/Documents/proejcts/laravel/ext/adeel/service_onDemand/resources/views/frontend/pages/services/service-book.blade.php ENDPATH**/ ?>