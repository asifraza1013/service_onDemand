                    ...
                    <div class="total_service_day_count mt-4 mt-lg-5">
                        <form class="total_service_day" action="<?php echo e(route('seller.update.totalday')); ?>" method="post">
                            ...
                            <div class="form_service_day">
                                ...
                                <small style="text-align:left;" class="text-danger"><?php echo e(__('selected days will show while booking an order')); ?></small>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/asifraza/Documents/proejcts/laravel/ext/adeel/service_onDemand/resources/views/frontend/user/seller/day-and-schedule/days.blade.php ENDPATH**/ ?>