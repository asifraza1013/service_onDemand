        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $('.confirm-location .next').on('click', function() {
                    ...
                    if(area_name=='' ){
                        Command: toastr["warning"]("Please select your area !", "Warning")
                        toastr.options = {
                            "closeButton": true,
                            "debug": false,
                            "newestOnTop": false,
                ...
                $("#service_available_dates").flatpickr({
                    minDate: "today",
                    maxDate: new Date().fp_incr(<?php echo e($days_count-1); ?>),
                    inline: true,
                    altInput: true,
                    altFormat: "F j, Y",
                    dateFormat: "Y-m-d",
                    ...
                    $.ajax({
                            ...
                            success:function(res){
                                ...
                                if (res.status == 'invalid') {
                                    Command: toastr["warning"]("<?php echo e(__('Coupon is invalid.!')); ?>", "Warning")
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
                                ...
                                if (res.status == 'expired') {
                                    Command: toastr["warning"]("<?php echo e(__('Coupon already expired.!')); ?>", "Warning")
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
                                ...
                                if (res.status == 'notapplicable') {
                                    Command: toastr["warning"]("<?php echo e(__('Coupon is not applicable for this service.!')); ?>", "Warning")
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
                                ...
                                if (res.status == 'emptycoupon') {
                                    Command: toastr["warning"]("<?php echo e(__('Please enter your coupon.!')); ?>", "Warning")
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
...
<?php $__env->stopSection(); ?><?php /**PATH /Users/asifraza/Documents/proejcts/laravel/ext/adeel/service_onDemand/resources/views/frontend/pages/services/service-book-js.blade.php ENDPATH**/ ?>