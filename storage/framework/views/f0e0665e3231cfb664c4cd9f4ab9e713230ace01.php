                            ...
                            <div class="col-lg-12 margin-top-40">
                                <div class="edit-profile">
                                    <div class="profile-info-dashboard">
                                        ...
                                        <small class="text-danger"><?php echo e(__('Submit your original documents so that the admin can verify you. Once verified a badge will show in your profile that increase your order posibility')); ?></small>
                                        <?php if(!is_null($seller_verify_info) && $seller_verify_info->status === 1): ?>
                                            <div class="alert alert-success"><?php echo e(__('your profile has been verified by admin')); ?></div>
                                        <?php else: ?>
...
<?php endif; ?>
    <?php $__env->stopSection(); ?>    
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\qixer_bytesed_laravel\@core\resources\views/frontend/user/seller/profile-verify/seller-profile-verify.blade.php ENDPATH**/ ?>