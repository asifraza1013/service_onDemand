                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul class="mb-3 text-danger">
                            <li><strong><?php echo e('Status Meaning:'); ?></strong></li>
                            <li><?php echo e('Pending: Did not start the job yet.'); ?></li>
                            <li><?php echo e('Active: Job already started.'); ?></li>
                            <li><?php echo e('Delivered: Order Deliverd For Checking.'); ?></li>
                            <li><?php echo e('Completed: Order is completed and closed.'); ?></li>
                        </ul>
...
<?php echo $__env->make('frontend.user.seller.seller-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/bytesed/public_html/laravel/qixer/beta/@core/resources/views/frontend/user/seller/order/pending-orders.blade.php ENDPATH**/ ?>