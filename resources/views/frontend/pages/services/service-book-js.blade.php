        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $("#service_available_dates").flatpickr({
                    minDate: "today",
                    maxDate: new Date().fp_incr({{ $days_count-1 }}),
                    inline: true,
                    altInput: true,
                    altFormat: "F j, Y",
                    dateFormat: "Y-m-d",
                    ...
                    $.ajax({
                            ...
                            success:function(res){
                                ...
                                if (res.status == 'invalid') {
                                    Command: toastr["warning"]("{{__('Coupon is invalid.!')}}", "Warning")
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
                                ...
                                if (res.status == 'expired') {
                                    Command: toastr["warning"]("{{__('Coupon already expired.!')}}", "Warning")
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
                                ...
                                if (res.status == 'notapplicable') {
                                    Command: toastr["warning"]("{{__('Coupon is not applicable for this service.!')}}", "Warning")
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
                                ...
                                if (res.status == 'emptycoupon') {
                                    Command: toastr["warning"]("{{__('Please enter your coupon.!')}}", "Warning")
                                    toastr.options = {
                                        "closeButton": true,
                                        "debug": false,
                                        "newestOnTop": false,
