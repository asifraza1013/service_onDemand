        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    @canany(['order-list','cancel-order-list','order-success-setting'])
                    <li
                        class="{{ active_menu('admin-home/orders') }}
                        @if (request()->is(['admin-home/orders','admin-home/orders/cancel-orders','admin-home/orders/order-success-settings','admin-home/orders/order-details*'])) active @endif">
                        <a href="javascript:void(0)" aria-expanded="true"><i class="ti-list-ol"></i>
